---
name: task-tracker
description: 任务追踪与日报周报生成。用于记录老板工作进度、生成日报周报、持续追踪任务完成情况。
---

# Task Tracker - 任务追踪与日报周报

## 核心文件
- 任务总表：`C:\Users\Administrator\.openclaw/workspace/TASKS.md`
...
## 追踪文件路径
`C:\Users\Administrator\.openclaw/workspace/TASKS.md`
